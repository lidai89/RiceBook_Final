...
const getArticles = (req,res) => {
	...
	console.log('what happened?'+id)
	if(id){//View it as article id for now
		console.log('faulse article options')
	...
	else{//No id provided, return all articles in the db.sort by time, limit by 10.
		console.log('get articles with no id')
